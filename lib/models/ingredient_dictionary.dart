// 재료 사전 데이터 모델: Firestore ingredients 컬렉션 문서와 1:1 매핑되는 표준 재료명 및 표현 변형 관리
class IngredientDictionary {
  ...
  // Firestore 문서 데이터를 IngredientDictionary 객체로 변환
  ...
  // 로컬 캐시 데이터를 IngredientDictionary 객체로 변환
