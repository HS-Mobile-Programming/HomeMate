...
제 1 장 총칙\n\n
        ...
        제 1 조 (목적)\n
        본 약관은 (주)집밥에이트(이하 “회사”라 합니다)이 운영하는 웹사이트 ‘한성대학교’ (www.hansung.ac.kr) (이하 “웹사이트”라 합니다)에서 제공하는 온라인 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버몰과 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.\n
